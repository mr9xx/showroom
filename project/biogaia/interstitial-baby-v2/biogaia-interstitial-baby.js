...
(lib.legalb_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.legalb_1, new cjs.Rectangle(-559.2,-95.2,1289.5,199.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-108.45,-370.55,1.1,1.1);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(74).to({_off:false},0).to({regX:0,regY:0,scaleX:1,scaleY:1,y:-361,alpha:1},24,cjs.Ease.cubicOut).wait(126).to({alpha:0},15).wait(86));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:-0.1,regY:-0.1,scaleX:1.1,scaleY:1.1,x:-2.8,y:-20.25,alpha:1},49,cjs.Ease.quartOut).wait(75).to({scaleX:1.0999,scaleY:1.0999,x:-2.75,y:-20.2},0).to({regY:-0.2,scaleX:1,scaleY:1,x:-2.8,y:-20.25},10,cjs.Ease.cubicInOut).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:-2.75},15,cjs.Ease.cubicOut).wait(75).to({regX:-0.1,regY:-0.2,x:-2.7,y:-20.2},0).to({regX:-0.2,scaleX:1,scaleY:1,x:-2.8},10,cjs.Ease.cubicInOut).to({regX:-0.1,regY:-0.1,scaleX:1.1,scaleY:1.1,y:-20.25},15,cjs.Ease.cubicOut).wait(76));

	// claim
	this.instance_5 = new lib.claim_1();
	this.instance_5.setTransform(0.85,240.35,0.8,0.8);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(4).to({_off:false},0).wait(1).to({scaleX:0.8376,scaleY:0.8376,x:0.8485,y:240.3485,alpha:0.0417},0).wait(1).to({scaleX:0.8674,scaleY:0.8674,x:0.8475,y:240.3475,alpha:0.0833},0).wait(1).to({scaleX:0.8913,scaleY:0.8913,x:0.8467,y:240.3467,alpha:0.125},0).wait(1).to({scaleX:0.9107,scaleY:0.9107,x:0.8461,y:240.3461,alpha:0.1667},0).wait(1).to({scaleX:0.9266,scaleY:0.9266,x:0.8458,y:240.3458,alpha:0.2083},0).wait(1).to({scaleX:0.9396,scaleY:0.9396,x:0.8455,y:240.3455,alpha:0.25},0).wait(1).to({scaleX:0.9505,scaleY:0.9505,x:0.8454,y:240.3454,alpha:0.2917},0).wait(1).to({scaleX:0.9595,scaleY:0.9595,alpha:0.3333},0).wait(1).to({scaleX:0.967,scaleY:0.967,alpha:0.375},0).wait(1).to({scaleX:0.9733,scaleY:0.9733,x:0.8455,y:240.3455,alpha:0.4167},0).wait(1).to({scaleX:0.9785,scaleY:0.9785,x:0.8457,y:240.3457,alpha:0.4583},0).wait(1).to({scaleX:0.9829,scaleY:0.9829,x:0.8459,y:240.3459,alpha:0.5},0).wait(1).to({scaleX:0.9866,scaleY:0.9866,x:0.8461,y:240.3461,alpha:0.5417},0).wait(1).to({scaleX:0.9896,scaleY:0.9896,x:0.8464,y:240.3464,alpha:0.5833},0).wait(1).to({scaleX:0.9921,scaleY:0.9921,x:0.8466,y:240.3466,alpha:0.625},0).wait(1).to({scaleX:0.9941,scaleY:0.9941,x:0.847,y:240.347,alpha:0.6667},0).wait(1).to({scaleX:0.9957,scaleY:0.9957,x:0.8473,y:240.3473,alpha:0.7083},0).wait(1).to({scaleX:0.9971,scaleY:0.9971,x:0.8476,y:240.3476,alpha:0.75},0).wait(1).to({scaleX:0.9981,scaleY:0.9981,x:0.848,y:240.348,alpha:0.7917},0).wait(1).to({scaleX:0.9988,scaleY:0.9988,x:0.8484,y:240.3484,alpha:0.8333},0).wait(1).to({scaleX:0.9994,scaleY:0.9994,x:0.8488,y:240.3488,alpha:0.875},0).wait(1).to({scaleX:0.9997,scaleY:0.9997,x:0.8492,y:240.3492,alpha:0.9167},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,x:0.8496,y:240.3496,alpha:0.9583},0).wait(1).to({scaleX:1,scaleY:1,x:0.9,y:240.4,alpha:1},0).wait(297));

	// cta
	this.instance_6 = new lib.cta();
	this.instance_6.setTransform(-0.15,380.15,0.8,0.8);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(9).to({_off:false},0).wait(1).to({scaleX:0.8376,scaleY:0.8376,x:-0.1485,y:380.1485,alpha:0.0417},0).wait(1).to({scaleX:0.8674,scaleY:0.8674,x:-0.1475,y:380.1475,alpha:0.0833},0).wait(1).to({scaleX:0.8913,scaleY:0.8913,x:-0.1467,y:380.1467,alpha:0.125},0).wait(1).to({scaleX:0.9107,scaleY:0.9107,x:-0.1461,y:380.1461,alpha:0.1667},0).wait(1).to({scaleX:0.9266,scaleY:0.9266,x:-0.1458,y:380.1458,alpha:0.2083},0).wait(1).to({scaleX:0.9396,scaleY:0.9396,x:-0.1455,y:380.1455,alpha:0.25},0).wait(1).to({scaleX:0.9505,scaleY:0.9505,x:-0.1454,y:380.1454,alpha:0.2917},0).wait(1).to({scaleX:0.9595,scaleY:0.9595,alpha:0.3333},0).wait(1).to({scaleX:0.967,scaleY:0.967,alpha:0.375},0).wait(1).to({scaleX:0.9733,scaleY:0.9733,x:-0.1455,y:380.1455,alpha:0.4167},0).wait(1).to({scaleX:0.9785,scaleY:0.9785,x:-0.1457,y:380.1457,alpha:0.4583},0).wait(1).to({scaleX:0.9829,scaleY:0.9829,x:-0.1459,y:380.1459,alpha:0.5},0).wait(1).to({scaleX:0.9866,scaleY:0.9866,x:-0.1461,y:380.1461,alpha:0.5417},0).wait(1).to({scaleX:0.9896,scaleY:0.9896,x:-0.1464,y:380.1464,alpha:0.5833},0).wait(1).to({scaleX:0.9921,scaleY:0.9921,x:-0.1466,y:380.1466,alpha:0.625},0).wait(1).to({scaleX:0.9941,scaleY:0.9941,x:-0.147,y:380.147,alpha:0.6667},0).wait(1).to({scaleX:0.9957,scaleY:0.9957,x:-0.1473,y:380.1473,alpha:0.7083},0).wait(1).to({scaleX:0.9971,scaleY:0.9971,x:-0.1476,y:380.1476,alpha:0.75},0).wait(1).to({scaleX:0.9981,scaleY:0.9981,x:-0.148,y:380.148,alpha:0.7917},0).wait(1).to({scaleX:0.9988,scaleY:0.9988,x:-0.1484,y:380.1484,alpha:0.8333},0).wait(1).to({scaleX:0.9994,scaleY:0.9994,x:-0.1488,y:380.1488,alpha:0.875},0).wait(1).to({scaleX:0.9997,scaleY:0.9997,x:-0.1492,y:380.1492,alpha:0.9167},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,x:-0.1496,y:380.1496,alpha:0.9583},0).wait(1).to({scaleX:1,scaleY:1,x:-0.2,y:380.2,alpha:1},0).wait(292));
	...
	// legal
	this.instance_8 = new lib.legalb_1();
	this.instance_8.setTransform(2.5,515.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(134).to({_off:false},0).to({alpha:1},15).wait(75).to({alpha:0},15).to({_off:true},11).wait(75));

	// serca
	this.instance_10 = new lib.serca("synched",0,false);
	this.instance_10.setTransform(33.65,-199.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({_off:true},224).wait(15).to({_off:false},0).wait(86));

	// bg1
	this.instance_11 = new lib.bg1();

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(325));
